    ...
    showDataPanelHTML += `
      <li class="list-group-item d-flex" style="justify-content:space-between;">
          ...
          <div class="right d-flex"> 
            <a href="#" class="btn btn-primary btn-show-movie m-1" data-bs-toggle="modal" data-bs-target="#movie-modal"
            data-id="${data[i].id}">More</a>
            <a class="btn btn-info btn-add-favorite m-1" data-id="${data[i].id}">+</a>
          </div>
      </li>
    `
  }
